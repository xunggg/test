...
def evaluate(evaluation_file, holdout_model_name, ens_models, attakc_method, dataset_name, dataset_path):
    ...
    adv_output_dir = os.path.join(ad_output_path, holdout_model_name, dataset_name, attack_method)
    ...
    for holdout_mname in ['ens_adv_inception_resnet_v2', 'adv_inception_v3']: 
        ...
        for ds_name, ds_path in victim_datasets:
            ...
            for attack_method in ['ENSDI-FGSM', 'ENSMI-FGSM', 'ENSBAP', 'ENSTI-FGSM', 'ENSSIT', 'ENSPoincare']:
                evaluate(ad_evaluation_file, holdout_mname, ens_models, attack_method, ds_name, ds_path)
    print('===evaluate end===')
