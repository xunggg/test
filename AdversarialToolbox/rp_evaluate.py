...
import numpy as np
from torchdefenses.RP import defense
...
if __name__ == '__main__':
    ...
    for holdout_mname in ['inception_v3']: 
        ...
        for ds_name, ds_path in victim_datasets:
            for defense_name in ['rp']:
                for attack_method in ['ENSDI-FGSM', 'ENSMI-FGSM', 'ENSBAP', 'ENSTI-FGSM', 'ENSSIT', 'ENSPoincare']:
                    evaluate(rp_evaluation_file, holdout_mname, ens_models, attack_method, ds_name, ds_path, defense_name)
    print('===evaluate end===')
